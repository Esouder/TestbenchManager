    ...
    def load_from_configuration(self, config: InstrumentConfiguration) -> None:
        ...
        for translator_config in config.translators:
            try:
                ...
                continue
            print(translator_config.model_dump())
            translator_config = translator_class.configuration().model_validate(translator_config.model_dump())
            try:
                print(f" translator class: {translator_class}")
